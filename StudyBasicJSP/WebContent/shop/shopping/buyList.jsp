<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="shop.productshop.shopping.BuyDataBean" %>
	...
	<table align="center">
		...
		<tr>
			...
			<td width="300" align="left">
				<img src="../../imageFile/<%=buyList.getProduct_image() %>"
				border="0" width="30" height="50" align="middle">
				<%=buyList.getProduct_title() %>
			</td>
			<td width="100">\
			<%=NumberFormat.getInstance().format(buyList.getBuy_price()) %></td>
...
%>
		<tr>
			<td colspan="5" align="right">
				...
				<b style="margin-right: 30px">총 금액 : \<%=NumberFormat.getInstance().format(total) %></b></font></td>
		</tr></table><br>
<%
